...
// imported from the same module the publishing service uses to classify
...
const CLASS_META: Record<PostFailureClass, { label: string; blurb: string }> = {
  recoverable: {
    ...
    blurb:
      'Temporary platform problems. Publishly waits and retries these automatically — usually you do nothing.',
  },
  user_action_needed: {
          ...
          <div className="mk-container">
            <div className="mk-reveal">
              ...
              <p className="mk-section-lede">
                Every failed Publishly post carries one of these codes — this is
                the engine&rsquo;s actual catalog, rendered from the same module
                the publishing service uses. It cannot drift from what the API
                returns.
              </p>
        ...
        <section className="mk-section" style={{ paddingTop: 32 }}>
          <div className="mk-container">
            <QuickAnswer>
              ...
              failure codes, each classed one of three ways: temporary failures
              retry automatically after a safe delay, needs-your-action failures
              wait for you to fix the connection or account, and content
              problems need the post itself changed. Each failure also fires a
              signed post.failure webhook carrying the code.
            </QuickAnswer>
          </div>
        </section>
