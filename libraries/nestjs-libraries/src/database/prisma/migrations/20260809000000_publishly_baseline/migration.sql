...
-- CreateIndex
CREATE INDEX "AnalyticsSnapshot_day_idx" ON "AnalyticsSnapshot"("day");

-- CreateIndex
CREATE UNIQUE INDEX "AnalyticsSnapshot_integrationId_day_label_key" ON "AnalyticsSnapshot"("integrationId", "day", "label");

-- CreateIndex
CREATE INDEX "BulkImport_organizationId_createdAt_idx" ON "BulkImport"("organizationId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "AnalyticsSnapshot" ADD CONSTRAINT "AnalyticsSnapshot_integrationId_fkey" FOREIGN KEY ("integrationId") REFERENCES "Integration"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BulkImport" ADD CONSTRAINT "BulkImport_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
